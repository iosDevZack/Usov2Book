...
//    Прежде, чем сцена будет отображена на экране, необходимо обновить значе- ние в правой текстовой метке. Для этого, в первую очередь, создадим словарь соответствия типа и строкового значения, которое должно быть отображено в правой текстовой метке.
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toTaskTypeScreen" {
            ...
            destination.doAfterTypeSelected = { selectedType in
